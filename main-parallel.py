...
# def process_village(state_code, dtcode11, block_code, village):
#     print(f"State_name: Telangana, district_name: {bl_codes[0]}, block_name: {village_codes[0]}, village_name: {village[0]}, Service level:{vil_d(state_code, dtcode11, village[1])}")
#     return {
...
# with ThreadPoolExecutor(max_workers=5) as executor:  # You can adjust max_workers based on your system capabilities
#     futures = []
#     for i in data:
#         keyvalue = i['KeyValue']
#         dtcode11 = ""
...
#             for village in village_codes[1]:
#                 futures.append(
#                     executor.submit(process_village, state_code, dtcode11, block_code, village)
#                 )
