...
for i in data:
    ...
    block_info_arr = dist2bl(state_code=state_code, dt_code=dtcode11, proxies=proxies,info_dict=info_dict)
    # pdb.set_trace()
    for block_code_dict in block_info_arr:
        ...
        dataframe = []
        vil_dict = bl2vl(state_code,dtcode11,block_code, info_dict=block_code_dict,proxies=proxies)
        # for village in vil_dict:
